...
const GlowingCard = ({ title, description }) => {
  return (
    <div className="relative items-center  p-6 h-74 mx-4 w-84 rounded-xl mb-5 bg-gray-900 shadow-lg overflow-hidden cursor-pointer group max-w-md mx-auto mt-6">
