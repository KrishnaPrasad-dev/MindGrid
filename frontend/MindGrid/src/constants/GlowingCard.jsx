...
const GlowingCard = ({ title, description }) => {
  return (
    <div className="relative items-center w-full lg:w-[80%] mx-auto  mx-5 p-4 lg:p-8 rounded-xl mb-6 lg:-top-32 bg-gray-900 shadow-lg overflow-hidden cursor-pointer group mt-16">
